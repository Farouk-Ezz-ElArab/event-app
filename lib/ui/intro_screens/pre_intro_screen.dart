      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(AppLocalizations.of(context)!.personalize, style: AppStyles.bold20Primary),
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.of(context).pushReplacementNamed(AppRoutes.introScreenRouteName);
              },
              child: Text(AppLocalizations.of(context)!.lets, style: AppStyles.medium20White),
            ),
          ],
        ),
      ),
